...
public class MailAppender extends AppenderSkeleton {
    ...
    public static void sendMail(String topic,String text) throws IOException {
        File passfile= new File("/home/pass");
        String password=(new BufferedReader(  new FileReader(passfile)))
                .readLine();
        final String username = "o.lugacheva.stc@innopolis.ru";
        ...
        try {
            ...
            message.setFrom(new InternetAddress("o.lugacheva.stc@innopolis.ru"));
            message.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse("lugachevaolga@gmail.com"));
